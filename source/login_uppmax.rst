...
reservation you need to use the salloc command like this::
  ...
  salloc -A g2014180 -t 08:00:00 -p core -n 8 --no-shell --reservation=check_below &
...
After you have chosen a sample you will create the file structure continuously throughout the workshop. `Here <https://drive.google.com/file/d/0B-ktNmaBM1yrSjhtbHdBcExMOE0/view?usp=sharing>`_ you can see an overview of what this structure should look like at the end of the day.
